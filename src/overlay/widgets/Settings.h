...
private:
    ...
    bool SettingItemButton(const std::string& acIcon, const std::string& acLabel, const std::string& acButtonText, const std::string& acTooltip, const float acWidth = 0);
