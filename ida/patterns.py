...
def get_groups() -> List[Group]:
    ...
    return [
        ...
        Group(name='CRenderNode_Present', functions=[
            Item(name='DoInternal', pattern='48 89 5C 24 08 48 89 6C 24 10 4C 89  4C 24 20 56 57 41 56 48 83 EC 30 8B 11 45 8B F0  48 8B 2D', expected=1) # ok
        ]),
        Group(name='CScript', functions=[
            ...
            Item(name='TranslateBytecode', pattern='48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 20 48 8B 1A 48 8B E9 8B 42 0C', expected=2, index=1), # ok
        ...
        Group(name='CWinapi', functions=[
            Item(name='ClipToCenter', pattern='48 89 5C 24 08 55 48 8B EC 48 83 EC 30 48 8B D9 48 8B 89 ? 01 00 00', expected=1) # ok
        ]),
        ...
        Group(name='CPatches', functions=[
            Item(name='BoundaryTeleport', pattern='48 8B C4 48 89 58 10 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 B0 48 81 EC ? 01 00 00 0F 29 ? B8 48 8D 51 48', expected=1),
